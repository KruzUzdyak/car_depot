...
INSERT INTO `car_depot`.`users` (`user_id`, `login`, `password`, `name`, `phone`, `role_id`)
VALUES (2, 'driver1', '$2a$10$Bb47ignhQuruq7nkFsVQCuqCxZJvoj3Cq29G3BOGb4HhKWbgJDak6', 'Gruzdev Anatoly', '+375336462214', 2);
INSERT INTO `car_depot`.`users` (`user_id`, `login`, `password`, `name`, `phone`, `role_id`)
VALUES (3, 'driver2', '$2a$10$d591kb2xhd0V6EzhAWiJfOxfImbs/BjW3gjZPB/bJd7DVaKhg4hT.', 'Samsonov Semen',  '+375354789476', 2);
INSERT INTO `car_depot`.`users` (`user_id`, `login`, `password`, `name`, `phone`, `role_id`)
VALUES (4, 'client1', '$2a$10$uIzLUf2wlG3cZzlHge/KyuBKhB5nSdyDkFjOUxEbEbELub9kIwFSK', 'Zuzkin Gennadiy', '+375356794315', 3);
INSERT INTO `car_depot`.`users` (`user_id`, `login`, `password`, `name`, `phone`, `role_id`)
VALUES (5, 'admin2', '$2a$10$HtuoSIiPCDGF4gQF44TDsO8pq0M2ZlugjySz9fP/ehvVNDy884OUm', 'Starkin Andrey', '+37529774544', 1);
INSERT INTO `car_depot`.`users` (`user_id`, `login`, `password`, `name`, `phone`, `role_id`)
VALUES (6, 'client2', '$2a$10$eeIc6X24Fr6iQ81M2P3GKecHZSVYvOLHR8GLapYCvTEVJL9uqLVNG', 'Kertov Grigoriy', '+375356634315', 3);
...
VALUES (2, 5, 1614190346000, '7AB250666');
INSERT INTO `car_depot`.`driver_licenses` (`user_id`, `license_id`, `obtaining_date`, `license_number`)
VALUES (3, 5, 1621190346000, '6BC654899');
INSERT INTO `car_depot`.`driver_licenses` (`user_id`, `license_id`, `obtaining_date`, `license_number`)
VALUES (3, 8, 1623190346000, '6MM645211');
-- -----------------------------------------------------
...
INSERT INTO `car_depot`.`admin_info` (`user_id`, `works_since`, `note`)
VALUES (5, 1615279946000, 'New worker');
